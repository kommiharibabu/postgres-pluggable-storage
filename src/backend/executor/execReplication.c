						 ...
						 TupleTableSlot *searchslot, TupleTableSlot *outslot)
{
	...
	/* FIXME */
	scanslot = MakeSingleTupleTableSlot(desc, TTS_TYPE_HEAPTUPLE);
						 ...
						 TupleTableSlot *searchslot, TupleTableSlot *slot)
{
	...
	if (!skip_tuple)
	{
		...
		table_update(rel, tid, slot, GetCurrentCommandId(true), InvalidSnapshot,
						 ...
						 TupleTableSlot *searchslot)
{
	...
	if (!skip_tuple)
	{
		...
		/* OK, delete the tuple */
		/* FIXME */
		table_delete(rel, tid, GetCurrentCommandId(true), InvalidSnapshot,
					 true,  &hufd, false);
